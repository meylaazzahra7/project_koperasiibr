    ...
    <div class="navbar">
      ...
      <nav>
        <ul>
          ...
          <li class="dropdown">
            <a href="event.php" class="active">Event & Media</a>
            </li>
            </div>
          </li>
        </ul>
  ...
  <main class="content">
    ...
    <div class="gallery">
      <div class="gallery-item">
        <img src="photo1.jpg" alt="Kunjungan UNJANI">
        <div class="overlay">Bhakti Sosial Khitanan Massal ke-27</div>
      </div>

      <div class="gallery-item">
        <img src="indobarat4.jpg" alt="Benchmarking UCIC">
        <div class="overlay">blalbalal</div>
      </div>

      <div class="gallery-item">
        <img src="logo2.jpg" alt="Workshop Mahasiswa">
        <div class="overlay">blablabala</div>
      </div>
    </div>
  </main>
